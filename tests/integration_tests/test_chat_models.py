...
class TestChatParallelWebIntegration(ChatModelIntegrationTests):
    ...
    def supports_json_mode(self) -> bool:
        """Parallel AI Chat API JSON mode support - currently not implemented."""
        return False

    @property
    def supports_image_urls(self) -> bool:
        """Parallel AI Chat API does not support image URLs."""
        return False
    ...
    def supports_image_tool_message(self) -> bool:
        """Parallel AI Chat API does not support image tool messages."""
        return False
